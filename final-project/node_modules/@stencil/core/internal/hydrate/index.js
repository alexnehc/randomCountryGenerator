...
const createElm = (e, t, o, n) => {
 ...
 let a, r, i, d = 0;
 if (BUILD.slotRelocation && !useNativeShadowDom && (checkSlotRelocate = !0, "slot" === l.$tag$ && (scopeId && n.classList.add(scopeId + "-s"), 
 l.$flags$ |= l.$children$ ? 2 : 1)), BUILD.isDev && l.$elm$ && consoleDevError(`The JSX ${null !== l.$text$ ? `"${l.$text$}" text` : `"${l.$tag$}" element`} node should not be shared within the same renderer. The renderer caches element lookups in order to improve performance. However, a side effect from this is that the exact same JSX node should not be reused. For more information please see https://stenciljs.com/docs/templating-jsx#avoid-shared-jsx-nodes`), 
 BUILD.vdomText && null !== l.$text$) a = l.$elm$ = doc.createTextNode(l.$text$); else if (BUILD.slotRelocation && 1 & l.$flags$) a = l.$elm$ = BUILD.isDebug || BUILD.hydrateServerSide ? slotReferenceDebugNode(l) : doc.createTextNode(""); else {
  if (BUILD.svg && !isSvgMode && (isSvgMode = "svg" === l.$tag$), a = l.$elm$ = BUILD.svg ? doc.createElementNS(isSvgMode ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", BUILD.slotRelocation && 2 & l.$flags$ ? "slot-fb" : l.$tag$) : doc.createElement(BUILD.slotRelocation && 2 & l.$flags$ ? "slot-fb" : l.$tag$), 
  BUILD.svg && isSvgMode && "foreignObject" === l.$tag$ && (isSvgMode = !1), BUILD.vdomAttribute && updateElement(null, l, isSvgMode), 
  (BUILD.shadowDom || BUILD.scoped) && null != scopeId && a["s-si"] !== scopeId && a.classList.add(a["s-si"] = scopeId), 
  l.$children$) for (d = 0; d < l.$children$.length; ++d) r = createElm(e, l, d, a), 
  r && a.appendChild(r);
  BUILD.svg && ("svg" === l.$tag$ ? isSvgMode = !1 : "foreignObject" === a.tagName && (isSvgMode = !0));
 }
 return a["s-hn"] = hostTagName, BUILD.slotRelocation && 3 & l.$flags$ && (a["s-sr"] = !0, 
 a["s-fs"] = null === (s = l.$attrs$) || void 0 === s ? void 0 : s.slot, a["s-cr"] = contentRef, 
 a["s-sn"] = l.$name$ || "", i = e && e.$children$ && e.$children$[o], i && i.$tag$ === l.$tag$ && e.$elm$ && (BUILD.experimentalSlotFixes ? relocateToHostRoot(e.$elm$) : putBackInOriginalLocation(e.$elm$, !1))), 
 a;
 ...
 o["s-sh"] = void 0, 1 === o.nodeType && o["s-sn"] && o.setAttribute("slot", o["s-sn"]), 
 checkSlotRelocate = !0);
 plt.$flags$ &= -2;
 ...
 BUILD.updatable && null !== n && null !== s ? ((e, t, o, n) => {
  ...
  $ = t[++a], h = n[++r]; else if (isSameVnode(m, f)) patch(m, f), m = t[--c], f = n[--p]; else if (isSameVnode($, f)) !BUILD.slotRelocation || "slot" !== $.$tag$ && "slot" !== f.$tag$ || putBackInOriginalLocation($.$elm$.parentNode, !1), 
  patch($, f), e.insertBefore($.$elm$, m.$elm$.nextSibling), $ = t[++a], f = n[--p]; else if (isSameVnode(m, h)) !BUILD.slotRelocation || "slot" !== $.$tag$ && "slot" !== f.$tag$ || putBackInOriginalLocation(m.$elm$.parentNode, !1), 
  ...
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   for (const e of relocateNodes) {
    ...
    if (r) {
     ...
     BUILD.experimentalSlotFixes && 1 === t.nodeType && r["s-fs"] !== t.getAttribute("slot") && (r["s-fs"] ? t.setAttribute("slot", r["s-fs"]) : t.removeAttribute("slot")), 
 ...
 if (BUILD.experimentalSlotFixes && 2 & d.$flags$) for (const e of $.$elm$.childNodes) e["s-hn"] === hostTagName || e["s-sh"] || (o && null == e["s-ih"] && (e["s-ih"] = null !== (r = e.hidden) && void 0 !== r && r), 
 e.hidden = !0);
...
const callRender = (e, t, o, n) => {
 ...
 Object.defineProperty(e, "__textContent", t), BUILD.experimentalSlotFixes ? Object.defineProperty(e, "textContent", {
  get() {
