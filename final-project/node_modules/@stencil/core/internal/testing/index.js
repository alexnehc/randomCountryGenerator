...
const createElm = (e, t, a, o) => {
 ...
 "slot" === n.$tag$ && (scopeId && o.classList.add(scopeId + "-s"), n.$flags$ |= n.$children$ ? 2 : 1)), 
 appData.BUILD.isDev && n.$elm$ && consoleDevError(`The JSX ${null !== n.$text$ ? `"${n.$text$}" text` : `"${n.$tag$}" element`} node should not be shared within the same renderer. The renderer caches element lookups in order to improve performance. However, a side effect from this is that the exact same JSX node should not be reused. For more information please see https://stenciljs.com/docs/templating-jsx#avoid-shared-jsx-nodes`), 
 appData.BUILD.vdomText && null !== n.$text$) l = n.$elm$ = doc.createTextNode(n.$text$); else if (appData.BUILD.slotRelocation && 1 & n.$flags$) l = n.$elm$ = appData.BUILD.isDebug || appData.BUILD.hydrateServerSide ? slotReferenceDebugNode(n) : doc.createTextNode(""); else {
  if (appData.BUILD.svg && !isSvgMode && (isSvgMode = "svg" === n.$tag$), l = n.$elm$ = appData.BUILD.svg ? doc.createElementNS(isSvgMode ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", appData.BUILD.slotRelocation && 2 & n.$flags$ ? "slot-fb" : n.$tag$) : doc.createElement(appData.BUILD.slotRelocation && 2 & n.$flags$ ? "slot-fb" : n.$tag$), 
  appData.BUILD.svg && isSvgMode && "foreignObject" === n.$tag$ && (isSvgMode = !1), 
  appData.BUILD.vdomAttribute && updateElement(null, n, isSvgMode), (appData.BUILD.shadowDom || appData.BUILD.scoped) && null != scopeId && l["s-si"] !== scopeId && l.classList.add(l["s-si"] = scopeId), 
  n.$children$) for (p = 0; p < n.$children$.length; ++p) r = createElm(e, n, p, l), 
  r && l.appendChild(r);
  appData.BUILD.svg && ("svg" === n.$tag$ ? isSvgMode = !1 : "foreignObject" === l.tagName && (isSvgMode = !0));
 }
 return l["s-hn"] = hostTagName, appData.BUILD.slotRelocation && 3 & n.$flags$ && (l["s-sr"] = !0, 
 l["s-fs"] = null === (s = n.$attrs$) || void 0 === s ? void 0 : s.slot, l["s-cr"] = contentRef, 
 l["s-sn"] = n.$name$ || "", i = e && e.$children$ && e.$children$[a], i && i.$tag$ === n.$tag$ && e.$elm$ && (appData.BUILD.experimentalSlotFixes ? relocateToHostRoot(e.$elm$) : putBackInOriginalLocation(e.$elm$, !1))), 
 l;
 ...
 a["s-sh"] = void 0, 1 === a.nodeType && a["s-sn"] && a.setAttribute("slot", a["s-sn"]), 
 checkSlotRelocate = !0);
 plt.$flags$ &= -2;
 ...
 for (let e = o.length - 1; e >= 0; e--) {
  ...
  s["s-ol"].remove(), s["s-ol"] = void 0, s["s-sh"] = void 0, 1 === s.nodeType && s.setAttribute("slot", null !== (a = s["s-sn"]) && void 0 !== a ? a : ""), 
 ...
 appData.BUILD.updatable && null !== o && null !== s ? ((e, t, a, o) => {
  let s, n, l = 0, r = 0, i = 0, p = 0, d = t.length - 1, c = t[0], $ = t[d], u = o.length - 1, h = o[0], m = o[u];
  ...
  patch($, h), e.insertBefore($.$elm$, c.$elm$), $ = t[--d], h = o[++r]; else {
   if (i = -1, appData.BUILD.vdomKey) for (p = l; p <= d; ++p) if (t[p] && null !== t[p].$key$ && t[p].$key$ === h.$key$) {
    i = p;
    break;
   }
   appData.BUILD.vdomKey && i >= 0 ? (n = t[i], n.$tag$ !== h.$tag$ ? s = createElm(t && t[r], a, i, e) : (patch(n, h), 
   t[i] = void 0, s = n.$elm$), h = o[++r]) : (s = createElm(t && t[r], a, r, e), h = o[++r]), 
 ...
 patch(d, c), appData.BUILD.slotRelocation) {
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   for (const e of relocateNodes) {
    ...
    if (r) {
     ...
     appData.BUILD.experimentalSlotFixes && 1 === t.nodeType && r["s-fs"] !== t.getAttribute("slot") && (r["s-fs"] ? t.setAttribute("slot", r["s-fs"]) : t.removeAttribute("slot")), 
 ...
 if (appData.BUILD.experimentalSlotFixes && 2 & p.$flags$) for (const e of c.$elm$.childNodes) e["s-hn"] === hostTagName || e["s-sh"] || (a && null == e["s-ih"] && (e["s-ih"] = null !== (r = e.hidden) && void 0 !== r && r), 
 e.hidden = !0);
...
const callRender = (e, t, a, o) => {
 ...
 patchTextContent(e), patchChildSlotNodes(e, t);
}, patchCloneNode = e => {
 const t = e.cloneNode;
 ...
 Object.defineProperty(e, "__textContent", t), appData.BUILD.experimentalSlotFixes ? Object.defineProperty(e, "textContent", {
  get() {
